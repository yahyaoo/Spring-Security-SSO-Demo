...
package com.github.yahyaoo.security.authentication;
...
/**
 * see {@link AbstractUserDetailsAuthenticationProvider}
 *
 * @author yahyaoo
...
public class DemoUserDetailsAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public DemoUserDetailsAuthenticationProvider(PasswordEncoder passwordEncoder, UserDetailsService userDetailsService) {
        ...
        this.userDetailsService = (DemoUserDetailsService) userDetailsService;
    }
    ...
    protected UserDetails retrieveUser(String s, UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken) throws AuthenticationException {
        ...
        try {
            loadedUser = retrieveUser(demoAuthenticationToken);
    ...
    private UserDetails retrieveUser(DemoAuthenticationToken demoauthenticationtoken) {

        String principal = demoauthenticationtoken.getPrincipal().toString();
        String mail = demoauthenticationtoken.getMail();
        String integration = demoauthenticationtoken.getIntegration();

        UserDetails userDetails;
        if (!"".equals(integration)) {
            userDetails = this.userDetailsService.loadUserByUsernameOrMail(integration);
        } else {
            userDetails = this.userDetailsService.loadUserByUsernameAndMail(principal, mail);
        }
